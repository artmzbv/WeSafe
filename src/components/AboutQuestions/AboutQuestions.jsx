...
export default function AboutQuestions() {
    return(
        ...
        <section className='questions'>
            ...
            <p className='questions__paragraph'>{'Nous ne sommes ni conseilleurs financiers,\nni conseilleurs de patrimoine.'}</p>
            <p className='questions__paragraph'>{'Notre metier est les transactions\nsur les materieux critiques.'}</p>
            </div>
        </section>
        </>
    )
