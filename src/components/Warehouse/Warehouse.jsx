...
export default function Warehouse() {
  ...
  return (
    ...
    <h3 className='warehouse__title'>Nos entrepôts</h3>
    <p className='warehouse__description'>{`Nos entrepôts n'ont pas tous les mêmes caractéristiques. Seul l'entrepôt de Paris est pour l'instant en capacité de recevoir toutes les marchandises. Mais pour une diminution des coûts, vous pouvez opter pour un stockage dans plusieurs sites. `}
    <Link className='copper__intro-list-link' to="/contact-us">
{`Nos conseillers sont à votre disposition`}
</Link>
{` pour vous expliquer les modalités du stockage et les coûts afférents.`}
    </p>
